/**
 * Three.js raw uint8 volume renderer
 *
 * ----------------------------------------------------------------------------
 * Props
 * ----------------------------------------------------------------------------
 ...
 *
 * (NOT IMPLEMENTED) revolve      boolean  (default: false)
 *   When true, the volume rotates continuously around the Y axis.
 *   Mouse/orbit control is disabled while revolving
 * 
 ...
 *
 * opacityScale number  (default: 1.0)
 *   Global multiplier applied to the opacity of every voxel.
 *   Increase above 1.0 to make the volume appear more solid/opaque.
 *   Decrease below 1.0 to make it more transparent/ghostly.
 *
 * threshold    number  (default: 0.15)
 *   Normalised density value (0–1) below which voxels are fully transparent.
 *   Acts as a noise floor — raise it to hide low-density artefacts and reveal
 *   only the densest structures; lower it to show faint detail.
 *
 * colormap     Defined in VolumeShader.ts — edit the colormap() GLSL function
 *   there to change the colour scheme
 *
